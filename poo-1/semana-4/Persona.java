...
public class Persona {
  ...
  private final char sexo; // constante
  private int peso = 0;
  ...
  public Persona(
    String nombre, String apellido, String RUT, int edad, char sexo, int peso, double altura
  ) {
    this.nombre = nombre;
  ...
  // verifica si el sexo de la persona es correcto
  private char comprobarSexo(char sexo) {
    // si el sexo no 'H' o 'M', su valor por defecto será 'H'
    if (sexo != 'H' && sexo != 'M') {
      return 'H';
    }
